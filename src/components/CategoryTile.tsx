...
const CategoryTile: React.FC<TileProps> = ({ img, title }) => {
    return (
      <div className="rounded-lg relative w-[200px] h-[200px] flex-shrink-0 md:w-[225px] md:h-[225px] lg:w-[275px] lg:h-[275px] xl:w-[350px] xl:h-[350px] 2xl:w-[400px] 2xl:h-[400px] cursor-pointer">
