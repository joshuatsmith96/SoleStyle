      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <div className="flex flex-row gap-10">
          ...
          <Link to="/cart" className="relative">
            <p className={`cartCounter absolute text-white text-[16px] border z-10 bg-blue-400 w-[25px] h-[25px] rounded-full text-center top-[-10px] right-[-14px] flex flex-row justify-center items-center ${cartStyle}`}>{formattedCart.length === 0 ? "" : formattedCart.length}</p>
